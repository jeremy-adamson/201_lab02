...
// Purpose: To cycle through an array of questions and checks if user enters the correct response
// Input: Array of questions, Array of correct answers, Array of acceptable answers
// Output: Increments the global variable numberOfCorrect upon correct answer provided
...
// Purpose: To allow the user to guess a random number within a range (1 to numRange), given hints, and a number of attempts
// Input: The maximum number allowed for random number generation and the number of user guesses allowed
// Output: Correct number provided to user upon expiration of guesses, increments golbal variable numberOfCorrect upon correct answer provided
...
// Purpose: To have the user guess one of three favorite discs
// Input: The array of correct answers and the number of attempts the user can make
// Output: User provided feedback on if the entered value is within the accepted list and upon correct guess increments numberOfCorrect
...
function guessFavoriteDiscs(acceptableDiscs, numOfGuessesList){
    ...
    while (attempts <= numOfGuessesList){
        ...
        // Feedback to the user on if the correct answer was provided or not
        if (found){
...
// Purpose: To print out the list of acceptable discs
// Input: An array of acceptable discs
// Output: Prints out the list of acceptable discs for the user to see
